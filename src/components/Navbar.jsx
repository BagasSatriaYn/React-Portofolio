...
const Navbar = () => {
  ...
  return (
    <div className="navbar py-7 flex items-center justify-between">
      <div className="logo">
        <h1 className="text-3xl font-bold bg-white/90 backdrop-blur-sm text-black px-4 py-1 rounded-lg border border-white/20 md:border-none md:bg-transparent md:text-white transition-all">
          Portofolio
        </h1>
      </div>
      ...
      <ul
        ...
        ${active ? "top-0 opacity-100" : "-top-10 opacity-100"}`}
      >
        <li>
